...
const MasteryBadge: React.FC<{ level: number }> = ({ level }) => (
  <div className="w-24 h-24 relative flex items-center justify-center group shrink-0">
    <div className="absolute inset-0 bg-red-600 rounded-3xl rotate-12 group-hover:rotate-0 transition-transform shadow-xl shadow-red-100"></div>
    <div className="absolute inset-0 bg-gray-900 rounded-3xl -rotate-6 group-hover:rotate-0 transition-transform"></div>
    ...
    <div className="p-6 md:p-10 lg:p-12 space-y-12 animate-in fade-in duration-700">
      <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
        <div className="flex items-center gap-10">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
               <span className="px-3 py-1 bg-red-600 text-white text-[9px] font-black rounded-lg uppercase tracking-[0.2em] shadow-lg shadow-red-100">
                  {t('premium')}
               </span>
        ...
        <div className="flex gap-4 w-full lg:w-auto">
            {/* Streak Card */}
            <div className="flex-1 lg:flex-none bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 flex items-center gap-5 min-w-[160px] group transition-all hover:shadow-xl hover:-translate-y-1">
                <div className="w-14 h-14 bg-orange-100 rounded-2xl flex items-center justify-center relative overflow-hidden">
            ...
            {/* XP Card */}
            <div className="flex-1 lg:flex-none bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 flex items-center gap-5 min-w-[160px] group transition-all hover:shadow-xl hover:-translate-y-1">
                <div className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center relative overflow-hidden">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 bg-gray-900 rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl flex flex-col min-h-[460px]">
            <div className="relative z-10 flex justify-between items-start mb-10">
                ...
                {selectedDay !== null && (
                  <div className="text-right bg-white/5 px-8 py-4 rounded-3xl border border-white/10 backdrop-blur-sm shadow-2xl">
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-end">
                ...
                <div className="flex items-end gap-4 h-52 md:gap-6 relative z-10">
                    {weeklyData.map((item, i) => (
                        ...
                        >
                            <div className="w-full bg-white/5 rounded-2xl relative flex items-end overflow-hidden h-full border border-white/5 shadow-inner transition-colors group-hover:bg-white/10">
                                <div 
                                    className={`w-full rounded-t-xl transition-all duration-700 ease-out shadow-lg
            ...
            <div className="relative z-10 grid grid-cols-3 gap-8 mt-12 pt-10 border-t border-white/5">
        ...
        <div className="lg:col-span-4 bg-white rounded-[3rem] p-12 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div>
            ...
            <button 
                ...
                className="w-full py-6 bg-gray-900 text-white rounded-2xl font-black text-lg hover:bg-black active:scale-95 transition-all mt-12 shadow-xl shadow-gray-200 uppercase tracking-widest"
            >
                {t('resumeTraining')}
            </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {randomModules.map((unit) => (
                <div 
                  ...
                  className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all cursor-pointer group flex flex-col h-full"
                >
                    <div className={`w-16 h-16 aspect-square ${unit.color} rounded-2xl flex items-center justify-center text-4xl mb-8 group-hover:rotate-12 transition-transform shadow-xl border-4 border-white`}>
                        {unit.icon}
                    </div>
                    <div className="mb-4">
      ...
      <div 
        ...
        className="bg-red-600 rounded-[3rem] p-12 text-white flex flex-col md:flex-row items-center justify-between gap-10 cursor-pointer hover:bg-red-700 transition-all shadow-2xl brand-shadow group overflow-hidden relative"
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 text-center md:text-left relative z-10">
          <div className="w-24 h-24 aspect-square bg-white/20 rounded-3xl flex items-center justify-center relative border-2 border-white/20 shadow-2xl group-hover:rotate-12 transition-transform">
        ...
        <button 
          ...
          className="px-12 py-5 bg-white text-red-600 rounded-2xl font-black hover:scale-105 transition-transform text-sm uppercase tracking-[0.2em] shadow-2xl"
        >
          {t('launchCamera')}
        </button>
      </div>
