...
const Dashboard: React.FC<DashboardProps> = ({ setView }) => {
  ...
  return (
    <div className="p-6 md:p-8 lg:p-12 space-y-10 animate-in fade-in duration-700">
      ...
      <div 
        ...
        className="bg-[#1A1A1A] rounded-2xl p-8 md:p-12 border border-[#BD1023]/20 flex flex-col md:flex-row items-center justify-between gap-8 cursor-pointer hover:shadow-2xl hover:shadow-[#BD1023]/10 transition-all group overflow-hidden relative"
      >
