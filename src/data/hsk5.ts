...
export const hsk5Questions: Question[] = [
  // 听力模拟 (Listening Simulation) - Single Choice
  {
    ...
    options: {
      ...
      ja: ['A. 9点太早了', 'B. 他不会迟到', 'C. 可能不参加', 'D. 应该早点儿来'],
      'zh-TW': ['A. 9點太早了', 'B. 他不會遲到', 'C. 可能不參加', 'D. 應該早點兒來'],
    },
    correctAnswer: {
      zh: 'D. 应该早点儿来',
      en: 'D. 应该早点儿来',
  ...
  },
  {
    ...
    question: {
      ...
      en: '[Listening Simulation] Listen to the dialogue and choose the correct answer:\nMale: Have you read this report? Any opinions?\nFemale: 我还没来得及细看，等我看完再告诉你吧。\nQuestion: What does the woman mean?',
      ko: '[듣기 시뮬레이션] 대화를 듣고 올바른 답을 고르세요:\n남: 이 보고서 읽어봤나요? 의견이 있나요?\n여: 我还没来得及细看，等我看完再告诉你吧。\n질문: 여자의 말은 무슨 뜻입니까?',
      ja: '[リスニング模擬] 会話を聞いて、正しい答えを選んでください：\n男：这份报告你看了吗？有什么意见？\n女：我还没来得及细看，等我看完再告诉你吧。\n質問：女の人は何を意味していますか？',
      'zh-TW': '[聽力模擬] 聽對話，選擇正確答案：\n男：這份報告你看了嗎？有什麼意見？\n女：我還沒來得及細看，等我看完再告訴你吧。\n問：女的是什麼意思？',
    },
    options: {
      zh: ['A. 报告写得很好', 'B. 她不想看报告', 'C. 她还没看完', 'D. 她没有意见'],
      en: ['A. 报告写得很好', 'B. 她不想看报告', 'C. 她还没看完', 'D. 她没有意见'],
      ko: ['A. 报告写得很好', 'B. 她不想看报告', 'C. 她还没看完', 'D. 她没有意见'],
      ja: ['A. 报告写得很好', 'B. 她不想看报告', 'C. 她还没看完', 'D. 她没有意见'],
      'zh-TW': ['A. 報告寫得很好', 'B. 她不想看報告', 'C. 她還沒看完', 'D. 她沒有意見'],
    },
    correctAnswer: {
      zh: 'C. 她还没看完',
      en: 'C. 她还没看完',
  ...
  // 阅读 (Reading) - Single Choice (Fill in the blank in context)
  {
    ...
    question: {
      ...
      'zh-TW': '[閱讀] 選擇合適的詞語填空：\n在高速行駛的火車上，有一位老人不小心把剛買的新鞋從窗口掉下去一只，周圍的人都覺得很（ ___ ）。',
    },
    options: {
      zh: ['A. 浪费', 'B. 伤心', 'C. 可惜', 'D. 痛苦'],
      en: ['A. 浪费', 'B. 伤心', 'C. 可惜', 'D. 痛苦'],
      ko: ['A. 浪费', 'B. 伤心', 'C. 可惜', 'D. 痛苦'],
      ja: ['A. 浪费', 'B. 伤心', 'C. 可惜', 'D. 痛苦'],
      'zh-TW': ['A. 浪費', 'B. 傷心', 'C. 可惜', 'D. 痛苦'],
    },
    correctAnswer: 'C. 可惜',
    score: 15,
  },
