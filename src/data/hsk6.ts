...
export const hsk6Questions: Question[] = [
  // 听力模拟 (Listening Simulation) - Single Choice
  {
    ...
    question: {
      ...
      ja: '[リスニング模擬] 音声を聞いて、内容と一致するものを一つ選んでください：\n音声：童話の中の登場人物は、現実には存在しないことが多いです。童話の最大の特徴は豊かな想像力を使うことで、動物や植物に人間の感情を持たせ、子供たちに受け入れられやすくすることです。童話は主に子供向けに書かれていますが、童心を持つ大人も同様に童話の中に喜びを見出すことができます。',
    },
    options: {
      ...
      ja: ['A. 童話は想像力が豊かである', 'B. 大人は皆童話が好きである', 'C. 童話は大人向けに書かれている', 'D. 童話は子供の読書には適さない'],
    },
    correctAnswer: {
      zh: 'A. 童话想象力丰富',
      en: 'A. 童话想象力丰富',
  ...
  },
  {
    ...
    question: {
      ...
      ko: '[듣기 시뮬레이션] 녹음을 듣고 내용과 일치하는 항목을 고르세요:\n녹음: 이 경쟁이 치열한 시대에 평생 학습은 더 이상 구호가 아니라 생존 기술입니다. 자신의 지식 비축량을 끊임없이 업데이트해야만 직장에서 경쟁력을 유지할 수 있습니다.',
      ja: '[リスニング模擬] 音声を聞いて、内容と一致するものを一つ選んでください：\n音声：この競争の激しい時代において、生涯学習はもはや単なるスローガンではなく、生存スキルの一種です。自分の知識の蓄えを絶えず更新し続けてこそ、職場での競争力を維持できるのです。',
    },
    options: {
      zh: ['A. 竞争并不激烈', 'B. 学习只是口号', 'C. 知识更新很重要', 'D. 职场不需要竞争'],
      en: ['A. Competition is not fierce', 'B. Learning is just a slogan', 'C. Knowledge update is important', 'D. No competition needed in workplace'],
      ko: ['A. 경쟁이 치열하지 않다', 'B. 학습은 구호일 뿐이다', 'C. 지식 업데이트가 중요하다', 'D. 직장에는 경쟁이 필요 없다'],
      ja: ['A. 競争は激しくない', 'B. 学習は単なるスローガンである', 'C. 知識の更新が重要である', 'D. 職場に競争は必要ない'],
    },
    correctAnswer: 'C. 知识更新很重要',
    score: 10,
  },
