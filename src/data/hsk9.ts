...
export const hsk9Questions: Question[] = [
  // 听力 (Listening) - 40题
  {
    ...
    options: {
      ...
      ja: ['A. 因果律を否定した', 'B. 客観的実在性を揺るがした', 'C. 唯心論を証明した', 'D. 科学と宗教を統一した'],
    },
    correctAnswer: {
      zh: 'B. 动摇了客观实在性',
      en: 'B. 动摇 the objective reality',
      ko: 'B. 动摇了客观实在性',
      ja: 'B. 客観的実在性を揺るがした',
    },
    score: 1,
  },
  {
    ...
    options: {
      ...
      en: ['A. Establishing a global unified government', 'B. Eliminating cultural differences between countries', 'C. Win-win cooperation and common development', 'D. Implementing a single economic model'],
      ko: ['A. 글로벌 통일 정부 수립', 'B. 국가 간 문화 차이 해소', 'C. 협력 상생, 공동 발전', 'D. 단일 경제 모델 시행'],
      ja: ['A. 世界統一政府の樹立', 'B. 各国の文化の違いの解消', 'C. 協力・ウィンウィン、共同発展', 'D. 単一の経済モデルの実施'],
    },
    correctAnswer: 'C. 合作共赢、共同发展',
    score: 1,
  },
  // 阅读 (Reading) - 47题
  {
